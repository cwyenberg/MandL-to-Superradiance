...
t_dur = 1.e8                                # Simulation time duration (s).
t_sim_frac = 1.                             # Fraction of t_dur to actually execute     N/A TO THIS PAPER
...
E0_mean = 1.e-16                            # Incident electric field mean at z=0 (V/m).
...
gam_n_tau0 = 1.e7                           # Pump pulse delay (s). N/A TO THIS PAPPER
...
plotstep = 20                               # Number of time steps between visualisation frames of unfolding sim
